    ...
    App::new()
        .add_plugins(DefaultPlugins.set(WindowPlugin {
            primary_window: Some(Window {
                title: "vela".into(),
                // Keep drawing and pointer coordinates on the display's real
                // scale: forcing one on the web offsets clicks on HiDPI.
        ...
        .add_plugins(compass::CompassPlugin)
        ...
        .add_systems(
            ...
            (
                ...
                hud::update,
                hud::sea_button,
                hud::sync_controls.after(hud::sea_button),
                reflection::resize,
